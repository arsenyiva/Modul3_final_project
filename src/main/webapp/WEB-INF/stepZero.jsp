...
<div class="centered-content">
    ...
    <p class="sub-text"> И вот <%= session.getAttribute("username") %>, вы уже совсем рядом с замком </p>
    <p class="sub-text centered-text">Возле ворот замка стоит одинокий скучающий стражник. Лишь завидев вас, он сразу же
        обращается к вам.</p>
    <p class="sub-text centered-text">Здравствуй путник! Я думаю ты хочешь попасть в замок. Но сейчас мы пускаем только
        подданых нашего королества</p>
    <p class="sub-text centered-text">Ты таковым являешься? Или ты пришел к нам из других краев?</p>
</div>
<div class="button-container">
    <form method="post" action="quest">
        <button type="submit" name="answer" value="yes1">Да, я здешний</button>
    </form>
    <form method="post" action="bad_ending">
        <button type="submit" name="answer" value="no">Нет, я пришел издалека</button>
    </form>
</div>
