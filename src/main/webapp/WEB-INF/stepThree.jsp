...
<div class="centered-content">
    ...
    <p class="sub-text">Да ты прав! Мы никогда не потерпим в нашем замке магию и колдовство. Я уже почти верю, что ты
        действительно не чужестранец. Но остался последний финальный вопрос.</p>
    <p class="sub-text centered-text">Каждый житель нашего замка знает ответ на этот вопрос. Кто печет лучший хлеб и
        пироги в нашем замке?</p>
</div>
<div class="button-container">
    <form method="post" action="bad_ending">
        <button type="submit" name="answer" value="no">Эльза из кожевенного переулка</button>
    </form>
    <form method="post" action="good_ending">
        <button type="submit" name="answer" value="yes4">Грета из церковного тупика</button>
    </form>
</div>
